...
class Records
{
    ...
    {
        return $this->_driver->get("/dns/managed/$domainId/records{?type,rows,page}",
            array('type' => $type, 'rows' => $amount, 'page' => $page));
    }
    ...
    {
        return $this->_driver->get("/dns/managed/$domainId/records{?recordName,type}",
            array('recordName' => $recordName, 'type' => $type));
    }
