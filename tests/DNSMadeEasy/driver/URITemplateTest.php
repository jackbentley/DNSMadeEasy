...
use DNSMadeEasy\driver\URITemplate;
use tests\Base;

/**
 * Tests for the URI template.
 * Tests are from Guzzle: https://github.com/guzzle/guzzle/blob/master/tests/Guzzle/
 *
...
{
    /**
     * An instance of the uri template expander.
     * @var URITemplate
     */
